#ifndef DYNAMIC_RRT_RRT_NODE_CUDA_H
#define DYNAMIC_RRT_RRT_NODE_CUDA_H

#include "rrt_node.hpp"

namespace dynamic_rrt {

class RRTNodeCuda : public rclcpp::Node {
  public:
    RRTNodeCuda();
  ...
  private:
    ...
    void planOnGpu(const std::array<double, 2> &start, const std::array<double, 2> &goal,
...
#endif // DYNAMIC_RRT_RRT_NODE_CUDA_H
